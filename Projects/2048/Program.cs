...
public class Program
{
	...
	public static bool TryUpdate(int?[,] board, ref int score, Direction direction)
	{
	...
	public static IEnumerable<(int, int)> BoardValues(int?[,] board)
	{
	...
	public static ConsoleColor GetColor(int? value) =>
			value is null
				? ConsoleColor.DarkGray
				: Colors[(value.Value / 2 - 1) % Colors.Length];

	public static void Render(int?[,] board, int score)
	{
