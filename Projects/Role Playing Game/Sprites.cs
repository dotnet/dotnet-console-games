namespace Role_Playing_Game
{
	public static class Sprites
	{
		...
		public static readonly string[] IdleLeft = new[]
		{
			// 0
			@"   O   " + '\n' +
			@"  )|J  " + '\n' +
		...
		public static readonly string[] IdleRight = new[]
		{
			// 0
			@"   O   " + '\n' +
			@"  L|(  " + '\n' +
		...
		public static readonly string[] FallRight = new string[]
		{
			// 0
			@" ___O  " + '\n' +
			@" -'/   " + '\n' +
		...
		public static readonly string[] PunchLeft = new string[]
		{
			// 0
			@"  ._o_ " + '\n' +
			@"    |) " + '\n' +
